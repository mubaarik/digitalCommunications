...
class Source:
    def __init__(self, srctype, hdr, numbits, filename=None, bits_to_tx=None):
        '''
        Create a source of the given srctype, with an optional hdr (if
        hdr is True), with numbits payload bits,.
...
#        print 'Received', len(rcd_data), 'data bits:'
#        if self.srctype == "text":
